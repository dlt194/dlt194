...
- REST & webhook-driven services  
- Prisma, SQLAlchemy  

### Auth & Security
- Azure Entra ID (OAuth / OIDC)  
- NextAuth  
- AES-256-GCM encryption  
- Secure secret handling & rotation  

### DevOps & Infrastructure
- Docker & Docker Compose  
- Linux (bare metal & cloud)  
- CI-friendly, reproducible builds  
- Home-lab & self-hosted services  

### Telecom / Voice
- SIP, WebRTC  
- Avaya IP Office SDK & APIs  
- Zoom Contact Center  
- Call routing, recording ingestion, escalation logic  
